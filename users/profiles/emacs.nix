{
  ...
  dotsConfigPath = "${configHome}/dots/config";
  ...
  doomDir = "${dotsConfigPath}/${doomProfilePath}";
    ...
    "chemacs/profiles.el".text = ''
      (("doom" . ((user-emacs-directory . "${doomDataDir}")
                  (env . (("DOOMDIR" . "${doomDir}")
                          ...
                          ("EMACSDIR" . "${doomDataDir}")))
                  (server-name . "doom")))
       ("vanilla" . ((user-emacs-directory . "${dotsConfigPath}/${vanillaProfilePath}")))
       ("xtallos" . ((user-emacs-directory . "${dotsConfigPath}/${xtallosProfilePath}"))))
    '';
